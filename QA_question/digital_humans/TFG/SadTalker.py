...
from digital_humans.src.utils.preprocess import CropAndExtract
from digital_humans.src.test_audio2coeff import Audio2Coeff
from digital_humans.src.facerender.animate import AnimateFromCoeff
from digital_humans.src.generate_batch import get_data
from digital_humans.src.generate_facerender_batch import get_facerender_data
from digital_humans.src.utils.init_path import init_path
...
class SadTalker():
    ...
    def __init__(self, checkpoint_path='checkpoints', config_path='src/config', lazy_load=False):
        ...
        self.sadtalker_paths = init_path(checkpoint_path, self.config_path, 512, False, 'crop')
